...
//                 icon: Lightbulb,
//                 title: "WHO WE ARE",
//                 text: `Updeck is a strategic technology partner focused on helping businesses operate more
// intelligently, efficiently, and profitably.
// We believe technology should not be purchased because it is modern.
// It should be implemented because it solves a meaningful business problem.
// Our team combines business analysis, product strategy, design, engineering, automation, and
// data intelligence to create solutions that generate measurable value.
// Rather than approaching projects from a technology-first perspective, we begin by
// understanding the operational realities, growth objectives, and challenges facing each
// organization.
// This enables us to design systems that improve performance rather than simply adding
// functionality.`
//             },
//             {
//                 icon: Trophy,
//                 title: "MISSION",
//                 text: `To help organizations create measurable competitive advantages through intelligent technology
// and operational innovation`
//             },
//             {
//                 icon: Headphones,
//                 title: "VISION",
//                 text: `To become the strategic technology layer businesses rely on when growth, efficiency, and
// transformation become critical priorities.`
//             }
//         ],
...
export const content = {
    heroSection: {
        ...
        description: "Updeck helps ambitious organizations identify operational inefficiencies, unlock growth opportunities, and implement technology solutions that create measurable business outcomes.",
        scrollText: "Scroll Down",
        ...
        featureCards: [
            {
                ...
                title: "WHO WE ARE",
                // REPLACED: Updated with client document content
                text: `Updeck is a strategic technology partner focused on helping businesses operate more intelligently, efficiently, and profitably.

We believe technology should not be purchased because it is modern. It should be implemented because it solves a meaningful business problem.

Our team combines business analysis, product strategy, design, engineering, automation, and data intelligence to create solutions that generate measurable value.

Rather than approaching projects from a technology-first perspective, we begin by understanding the operational realities, growth objectives, and challenges facing each organization.

This enables us to design systems that improve performance rather than simply adding functionality.`
            },
            {
                icon: Trophy,
                title: "MISSION",
                // REPLACED: Updated with client document content
                text: `To help organizations create measurable competitive advantages through intelligent technology and operational innovation.`
            },
            {
                icon: Headphones,
                title: "VISION",
                // REPLACED: Updated with client document content
                text: `To become the strategic technology layer businesses rely on when growth, efficiency, and transformation become critical priorities.`
            }
        ],
