...
export default function AboutSection() {
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-[1296px] grid-cols-1 gap-5 lg:grid-cols-[1fr_1fr] items-stretch">
        {/* Left Image Area */}
        <div
          ref={leftImageRef}
          className="relative h-full min-h-[400px] opacity-0 lg:min-h-[500px]"
        >
          ...
          >
            {/* <p className="mb-6 text-[15px] font-medium tracking-[-0.02em] text-[#188b88] dark:text-[#4ecdc4]">
            ...
            <p className="mt-4 text-[15px] font-medium tracking-[-0.02em] text-[#188b88] dark:text-[#4ecdc4]">
              {aboutSection.experienceLabel}
            </p>
        ...
        <div className="flex h-full flex-col gap-5">
          ...
          <div
            ref={rightTopRef}
            className="flex h-full flex-col rounded-[10px] bg-white dark:bg-[#0f1f1d] px-8 py-8 opacity-0 shadow-[0_4px_20px_rgba(7,21,21,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)]"
          >
            ...
            <h2 className="mb-auto overflow-hidden text-[38px] font-normal leading-[1.15] tracking-[-0.055em] text-[#071515] dark:text-[#e8edee] sm:text-[46px] lg:text-[50px] xl:text-[52px]">
              <span className="about-text-reveal block">{aboutSection.headingLine1}</span>
              <span className="about-text-reveal block">{aboutSection.headingLine2}</span>
