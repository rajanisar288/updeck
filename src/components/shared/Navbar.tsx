...
const navLinks = [
  ...
  { label: 'Business Impact', path: '/business-impact' },
...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Navbar */}
      <header className="fixed left-0 right-0 top-0 z-50 px-[10px] rounded-[12px] overflow-hidden">
        <nav
          className={[
        ...
        >
          ...
          <Link to="/" className="relative z-10 flex items-center gap-2.5">
            <img
              src={theme === 'dark' ? '/images/logo/main-white.png' : '/images/logo1.png'}
              alt="Logo"
