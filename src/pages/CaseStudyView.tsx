    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            gsap.fromTo(
                ...
                { y: 0, opacity: 1, clipPath: 'inset(0% 0 0 0)', duration: 1.4, ease: 'power4.out', delay: 0.1 }
            );
        ...
        return (
            <main className="flex min-h-[60vh] items-center justify-center bg-[var(--color-base)] dark:bg-[#0a1a18]">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-[#071515] dark:text-white">Case Study Not Found</h1>
                    <Link to="/portfolios" className="mt-6 inline-flex items-center gap-2 text-[#188b88] hover:underline dark:text-[#4ecdc4]">
                ...
                <div className="relative min-h-[400px] overflow-hidden rounded-[8px] bg-[#061f20]">
                    ...
                    <div className="relative z-10 mx-auto flex min-h-[400px] max-w-[1000px] flex-col items-center justify-center px-4 text-center sm:px-6 lg:px-12">
                        ...
                        <div className="hero-breadcrumb mt-8 inline-flex flex-wrap items-center justify-center gap-2 rounded-full bg-white/10 px-5 py-2.5 text-[14px] font-semibold text-white/75 backdrop-blur-md">
                            ...
                            <Link to="/portfolios" className="transition-colors hover:text-white">Portfolios</Link>
                            <ChevronRight className="h-4 w-4 text-white/45" />
                ...
                <div className="mx-auto max-w-[1100px]">
                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                        <div className="reveal rounded-[16px] bg-white p-8 shadow-sm dark:bg-[#0f1f1d]">
                            <h3 className="mb-4 text-[24px] font-bold text-[#071515] dark:text-white">The Challenge</h3>
                            <p className="text-[17px] leading-[1.6] text-[#435151] dark:text-[#9daaaa]">
                                {study.challenge}
                            </p>
                        </div>
                        <div className="reveal rounded-[16px] bg-white p-8 shadow-sm dark:bg-[#0f1f1d]">
                            <h3 className="mb-4 text-[24px] font-bold text-[#071515] dark:text-white">Our Approach</h3>
                            <p className="text-[17px] leading-[1.6] text-[#435151] dark:text-[#9daaaa]">
                                {study.approach}
                            </p>
                        </div>
                        <div className="reveal rounded-[16px] bg-white p-8 shadow-sm dark:bg-[#0f1f1d]">
                            <h3 className="mb-4 text-[24px] font-bold text-[#071515] dark:text-white">Development</h3>
                            <p className="text-[17px] leading-[1.6] text-[#435151] dark:text-[#9daaaa]">
                                {study.Development}
                            </p>
                        </div>
                    ...
                    <div className="reveal mt-16 rounded-[16px] bg-white border border-[#e5ecec] p-8 dark:bg-[#152624] dark:border-[#2a3f3d] sm:p-12">
                        <h2 className="mb-10 text-center text-[36px] font-bold text-[#071515] dark:text-white">The Solution</h2>
                        <div className="solution-grid grid gap-6 sm:grid-cols-2">
                            {study.Solution.map((sol, index) => (
                                <div key={index} className="solution-item flex gap-4 rounded-[12px] bg-[#f4f7f7] p-6 dark:bg-[#0f1f1d]">
                                    <CheckCircle2 className="mt-1 h-6 w-6 shrink-0 text-[#188b88] dark:text-[#4ecdc4]" />
                                    <div>
                                        <h4 className="mb-2 text-[19px] font-bold text-[#071515] dark:text-white">{sol.title}</h4>
                                        <p className="text-[15px] leading-[1.6] text-[#435151] dark:text-[#9daaaa]">{sol.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
