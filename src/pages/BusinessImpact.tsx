...
function PillButton({
    ...
    return (
        ...
        >
            ...
            <span
                className={`ml-4 flex h-9 w-9 items-center justify-center rounded-full transition-transform duration-300 group-hover:rotate-45 ${dark
...
function FeatureCard({ item }: { item: any }) {
    ...
    return (
        ...
        >
            ...
            <h3 className="mb-5 text-[22px] font-bold leading-none tracking-[-0.04em] text-[#071515] transition-colors duration-500 group-hover:text-white dark:text-[#e8edee] dark:group-hover:text-[#0a1a18]">
                {item.title}
            </h3>
